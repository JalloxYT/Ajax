...
console.log("Ajax Bot made by Xeiji ");
console.log("Bot is online ")
console.log("Please enter the password for AjaxBot for it become online")
console.log("Ajax146")
...
var botConfigs = {
    token: "NTc4MDA1MDcwNzQ3MDA5MDM0.XNtzzA.6hj56RJ0t2Df2vZPuSaAuRItByA",
    prefix: ".",
    gameStatus: "on AjaxNetwork",
    statusType: "Watching Out",
    commands: [],
    plugins: [
    {
        "id": 0,
    ...
    ticketsystem: {
    "ticketCategoryID": "578042783609389066",
    "createTicketChannelID": "570407734151872545"
}
};
